...
const (
	Signer_MtA_FullMethodName = "/signer.Signer/MtA"
)
...
type SignerClient interface {
	...
	MtA(ctx context.Context, in *MtARequest, opts ...grpc.CallOption) (*MtAResponse, error)
}
...
func (c *signerClient) MtA(ctx context.Context, in *MtARequest, opts ...grpc.CallOption) (*MtAResponse, error) {
	out := new(MtAResponse)
	err := c.cc.Invoke(ctx, Signer_MtA_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SignerServer interface {
	// rpc sendSignature(sendSigantureRequest) returns (sendSigantureResponse);
	MtA(context.Context, *MtARequest) (*MtAResponse, error)
...
func (UnimplementedSignerServer) MtA(context.Context, *MtARequest) (*MtAResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MtA not implemented")
}
...
func _Signer_MtA_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MtARequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SignerServer).MtA(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Signer_MtA_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SignerServer).MtA(ctx, req.(*MtARequest))
	}
